...
const AdminDashboard = () => {
  ...
  const items = [
    ...
    getItem("Maintance Mangement", "over-time", <MailFilled />, [
      getItem(
        <Link to="/Service">Maintenance</Link>,
        "all-maintances",
        <PlusCircleFilled />
      ),
      ...
      getItem(
        <Link to="/Service">Service Management</Link>,
        "add-main",
        <PlusCircleFilled />
      ),
      ...
      getItem(
        <Link to="/Breakdown">BreakDown Management</Link>,
        "add-main",
        <PlusCircleFilled />
      ),
      getItem(
        <Link to="/BreakdownNotification">Notifications</Link>,
        "add-main",
        <PlusCircleFilled />
      ),*/}
    ]),
    ...
    getItem(
      <Link to="/admin/inventory">Inventory</Link>,"inventory",<MailFilled />,[
        getItem(
          <Link to="/SubInventory">Submitted Inventory</Link>,
          "SubInventory",
          <BookFilled />
        ),
